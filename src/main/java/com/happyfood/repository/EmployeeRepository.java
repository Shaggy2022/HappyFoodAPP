...
public interface EmployeeRepository extends JpaRepository<Employee, Long> {
    ...
    @Query(
        value = "select distinct employee from Employee employee left join fetch employee.user left join fetch employee.workDay left join fetch employee.manager",
    ...
    @Query(
        "select distinct employee from Employee employee left join fetch employee.user left join fetch employee.workDay left join fetch employee.manager"
    )
