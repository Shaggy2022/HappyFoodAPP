...
import com.happyfood.service.HoraryService;
...
/**
 * REST controller for managing {@link com.happyfood.domain.Horary}.
 */
@RestController
@RequestMapping("/api")
public class HoraryResource {
    ...
    public ResponseEntity<HoraryDTO> updateHorary(
        ...
        HoraryDTO result = horaryService.update(horaryDTO);
        return ResponseEntity
            .ok()
