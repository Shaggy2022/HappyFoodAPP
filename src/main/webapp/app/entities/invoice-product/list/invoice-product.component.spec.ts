...
describe('InvoiceProduct Management Component', () => {
  let comp: InvoiceProductComponent;
  let fixture: ComponentFixture<InvoiceProductComponent>;
  let service: InvoiceProductService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'invoice-product', component: InvoiceProductComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(InvoiceProductComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.invoiceProducts?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
