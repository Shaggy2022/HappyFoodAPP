...
describe('WorkDay Management Component', () => {
  let comp: WorkDayComponent;
  let fixture: ComponentFixture<WorkDayComponent>;
  let service: WorkDayService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'work-day', component: WorkDayComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(WorkDayComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.workDays?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
