package com.happyfood.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.happyfood.IntegrationTest;
import com.happyfood.repository.timezone.DateTimeWrapper;
import com.happyfood.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM happy_date_time_wrapper where id=%d", fieldName, id);
    }
