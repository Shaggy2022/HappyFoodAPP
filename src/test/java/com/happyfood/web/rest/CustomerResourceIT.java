...
class CustomerResourceIT {
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getFirstLastname()).isEqualTo(DEFAULT_FIRST_LASTNAME);
        ...
        assertThat(testCustomer.getDocumentNumber()).isEqualTo(DEFAULT_DOCUMENT_NUMBER);
    }
    ...
    void checkFirstLastnameIsRequired() throws Exception {
        int databaseSizeBeforeTest = customerRepository.findAll().size();
        // set the field null
        customer.setFirstLastname(null);
    ...
    void putNewCustomer() throws Exception {
        ...
        assertThat(testCustomer.getFirstLastname()).isEqualTo(UPDATED_FIRST_LASTNAME);
        ...
        assertThat(testCustomer.getDocumentNumber()).isEqualTo(UPDATED_DOCUMENT_NUMBER);
    }
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.firstName(UPDATED_FIRST_NAME).address(UPDATED_ADDRESS);
