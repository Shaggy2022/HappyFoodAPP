...
class OrderResourceIT {
    ...
    private static final String UPDATED_ORDER_REQUIRED = "BBBBBBBBBB";
    ...
    private static final BigDecimal DEFAULT_FULL_ORDER_VALUE = new BigDecimal(1);
    private static final BigDecimal UPDATED_FULL_ORDER_VALUE = new BigDecimal(2);
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order()
            .orderRequired(DEFAULT_ORDER_REQUIRED)
            .date(DEFAULT_DATE)
            .amount(DEFAULT_AMOUNT)
            .fullOrderValue(DEFAULT_FULL_ORDER_VALUE);
        // Add required entity
        Customer customer;
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order()
            .orderRequired(UPDATED_ORDER_REQUIRED)
            .date(UPDATED_DATE)
            .amount(UPDATED_AMOUNT)
            .fullOrderValue(UPDATED_FULL_ORDER_VALUE);
        // Add required entity
        Customer customer;
        if (TestUtil.findAll(em, Customer.class).isEmpty()) {
    ...
    void createOrder() throws Exception {
        ...
        assertThat(testOrder.getOrderRequired()).isEqualTo(DEFAULT_ORDER_REQUIRED);
        assertThat(testOrder.getDate()).isEqualTo(DEFAULT_DATE);
        assertThat(testOrder.getAmount()).isEqualTo(DEFAULT_AMOUNT);
        assertThat(testOrder.getFullOrderValue()).isEqualByComparingTo(DEFAULT_FULL_ORDER_VALUE);
    }
    ...
    @Test
    @Transactional
    void checkOrderRequiredIsRequired() throws Exception {
        int databaseSizeBeforeTest = orderRepository.findAll().size();
        // set the field null
        order.setOrderRequired(null);
    ...
    @Test
    @Transactional
    void checkFullOrderValueIsRequired() throws Exception {
        int databaseSizeBeforeTest = orderRepository.findAll().size();
        // set the field null
        order.setFullOrderValue(null);
    ...
    void getAllOrders() throws Exception {
        ...
        restOrderMockMvc
            ...
            .andExpect(jsonPath("$.[*].orderRequired").value(hasItem(DEFAULT_ORDER_REQUIRED)))
            .andExpect(jsonPath("$.[*].date").value(hasItem(DEFAULT_DATE.toString())))
            .andExpect(jsonPath("$.[*].amount").value(hasItem(DEFAULT_AMOUNT)))
            .andExpect(jsonPath("$.[*].fullOrderValue").value(hasItem(sameNumber(DEFAULT_FULL_ORDER_VALUE))));
    }
    ...
    void getOrder() throws Exception {
        ...
        restOrderMockMvc
            ...
            .andExpect(jsonPath("$.orderRequired").value(DEFAULT_ORDER_REQUIRED))
            .andExpect(jsonPath("$.date").value(DEFAULT_DATE.toString()))
            .andExpect(jsonPath("$.amount").value(DEFAULT_AMOUNT))
            .andExpect(jsonPath("$.fullOrderValue").value(sameNumber(DEFAULT_FULL_ORDER_VALUE)));
    }
    ...
    void putNewOrder() throws Exception {
        ...
        Order testOrder = orderList.get(orderList.size() - 1);
        assertThat(testOrder.getOrderRequired()).isEqualTo(UPDATED_ORDER_REQUIRED);
        assertThat(testOrder.getDate()).isEqualTo(UPDATED_DATE);
        assertThat(testOrder.getAmount()).isEqualTo(UPDATED_AMOUNT);
        assertThat(testOrder.getFullOrderValue()).isEqualByComparingTo(UPDATED_FULL_ORDER_VALUE);
    }
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.orderRequired(UPDATED_ORDER_REQUIRED).amount(UPDATED_AMOUNT).fullOrderValue(UPDATED_FULL_ORDER_VALUE);
