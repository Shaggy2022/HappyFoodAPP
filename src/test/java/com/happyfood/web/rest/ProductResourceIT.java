...
class ProductResourceIT {
    ...
    private static final String DEFAULT_REQUIRED_PRODUCT = "AAAAAAAAAA";
    private static final String UPDATED_REQUIRED_PRODUCT = "BBBBBBBBBB";
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().serial(DEFAULT_SERIAL).requiredProduct(DEFAULT_REQUIRED_PRODUCT).price(DEFAULT_PRICE);
        // Add required entity
        Inventory inventory;
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().serial(UPDATED_SERIAL).requiredProduct(UPDATED_REQUIRED_PRODUCT).price(UPDATED_PRICE);
        // Add required entity
        Inventory inventory;
        if (TestUtil.findAll(em, Inventory.class).isEmpty()) {
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getRequiredProduct()).isEqualTo(DEFAULT_REQUIRED_PRODUCT);
    ...
    @Test
    @Transactional
    void checkRequiredProductIsRequired() throws Exception {
        int databaseSizeBeforeTest = productRepository.findAll().size();
        // set the field null
        product.setRequiredProduct(null);
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].requiredProduct").value(hasItem(DEFAULT_REQUIRED_PRODUCT)))
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.requiredProduct").value(DEFAULT_REQUIRED_PRODUCT))
    ...
    void putNewProduct() throws Exception {
        ...
        updatedProduct.serial(UPDATED_SERIAL).requiredProduct(UPDATED_REQUIRED_PRODUCT).price(UPDATED_PRICE);
        ...
        assertThat(testProduct.getRequiredProduct()).isEqualTo(UPDATED_REQUIRED_PRODUCT);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.serial(UPDATED_SERIAL).requiredProduct(UPDATED_REQUIRED_PRODUCT).price(UPDATED_PRICE);
